    ...
    <>
      ...
      <section className="py-16" style={{ background: 'var(--c-bg)' }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="space-y-2">
            {faqs.map(({ q, a }, i) => (
              <div
                ...
                style={{ background: 'var(--c-card)', border: `1px solid ${open === i ? 'rgba(255,255,255,0.14)' : 'rgba(255,255,255,0.07)'}` }}
              >
                <button
          ...
          <div className="mt-12 p-6 rounded-2xl text-center" style={{ background: 'var(--c-card)', border: '1px solid rgba(255,255,255,0.07)' }}>
