        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="p-8 rounded-2xl" style={{ background: 'var(--c-card)', border: '1px solid rgba(255,255,255,0.07)' }}>
            ...
            <div className="mt-10 pt-8" style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
              <h2 className="font-serif text-xl font-bold text-white mb-4">Return Policy</h2>
              <div className="text-sm leading-[1.85] space-y-3" style={{ color: 'var(--c-muted)' }}>
                <p>All items are sold <strong className="text-white">as-is, where-is</strong>. We make every effort to accurately describe and photograph each lot; however, we do not offer refunds or exchanges after an item has been picked up.</p>
                <p>If an item is materially different from its description (e.g., a lot number mismatch), please contact us within <strong className="text-white">48 hours</strong> of pickup with photos. We will review each case individually and, at our discretion, may offer a partial credit toward a future auction.</p>
                <p>Unclaimed lots after <strong className="text-white">7 calendar days</strong> from auction close will be forfeited. No refunds will be issued for unclaimed items.</p>
              </div>
            </div>

            <div className="mt-10 pt-8" style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
              <h2 className="font-serif text-xl font-bold text-white mb-4">Shipping Policy</h2>
              <div className="text-sm leading-[1.85] space-y-3" style={{ color: 'var(--c-muted)' }}>
                <p>El Rachum Auctions LLC operates on a <strong className="text-white">pickup-only</strong> basis. We do not offer shipping or delivery services at this time.</p>
                <p>Winning bidders must pick up their items at our facility during scheduled pickup hours: <strong className="text-white">Tuesday & Thursday 11AM–5PM</strong> and <strong className="text-white">Saturday 10AM–2PM</strong>.</p>
            ...
            <div className="mt-10 p-5 rounded-xl" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)' }}>
              <p className="text-xs" style={{ color: 'var(--c-muted)' }}>
                Questions about this policy? Email us at <a href="mailto:info@example.ca" className="text-white underline hover:opacity-80">info@example.ca</a>. We will respond within 5 business days.
              </p>
            </div>
          </div>
        </div>
