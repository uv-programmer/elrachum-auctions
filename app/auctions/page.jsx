    ...
    <>
      <section className="py-12 text-center" style={{ background: 'var(--c-surface)', borderBottom: '1px solid var(--c-border)' }}>
        <div className="max-w-3xl mx-auto px-4">
          ...
          <h1 className="font-serif text-4xl font-bold mb-4" style={{ color: 'var(--c-text)' }}>Current <span style={{ color: 'var(--c-gold)' }}>Auctions</span></h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {HIBID_COMPANY_ID === '0' ? (
            <div className="rounded-2xl p-10 text-center" style={{ background: 'var(--c-card)', border: '1px solid var(--c-border)' }}>
              ...
              <h2 className="font-serif text-2xl font-bold mb-3" style={{ color: 'var(--c-text)' }}>Auctions Coming Soon</h2>
